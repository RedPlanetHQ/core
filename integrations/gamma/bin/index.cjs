...
// node_modules/.pnpm/@redplanethq+sdk@0.1.9/node_modules/@redplanethq/sdk/dist/index.mjs
init_cjs_shims();
...
async function gammaGet(path, apiKey, params) {
  const response = await axios_default.get(`${BASE_URL}${path}`, {
    headers: getHeaders(apiKey),
    params
  });
  return response.data;
}
async function gammaPost(path, apiKey, data) {
  const response = await axios_default.post(`${BASE_URL}${path}`, data, {
    headers: getHeaders(apiKey)
  });
  return response.data;
}
...
// src/account-create.ts
async function integrationCreate({ api_key }) {
  var _a5, _b;
  let user;
  try {
    ...
    throw new Error(
      `Failed to validate Gamma API key: ${((_b = (_a5 = error.response) == null ? void 0 : _a5.data) == null ? void 0 : _b.message) || error.message}`
    );
  }
...
async function fetchRecentPresentations(apiKey, lastSyncTime) {
  try {
    const data = await gammaGet("/presentations", apiKey, {
      updatedAfter: lastSyncTime,
      limit: 50
    });
    return (data == null ? void 0 : data.items) || (data == null ? void 0 : data.presentations) || data || [];
  } catch {
    return [];
  }
}
async function fetchRecentDocuments(apiKey, lastSyncTime) {
  try {
    const data = await gammaGet("/documents", apiKey, {
      updatedAfter: lastSyncTime,
      limit: 50
    });
    return (data == null ? void 0 : data.items) || (data == null ? void 0 : data.documents) || data || [];
  } catch {
    return [];
  }
}
async function fetchRecentWebsites(apiKey, lastSyncTime) {
  try {
    const data = await gammaGet("/websites", apiKey, {
      updatedAfter: lastSyncTime,
      limit: 50
    });
    return (data == null ? void 0 : data.items) || (data == null ? void 0 : data.websites) || data || [];
  } catch {
    return [];
  }
}
async function handleSchedule(config, state) {
  try {
    if (!(config == null ? void 0 : config.api_key)) {
      return [];
    }
    ...
    for (const item of presentations) {
      try {
        ...
        const url2 = item.url || item.shareUrl || item.publicUrl || "";
        messages.push(createActivityMessage(`Gamma presentation updated: "${title}"`, url2));
      } catch {
      }
    }
    ...
    for (const item of documents) {
      try {
        const title = item.title || item.name || "Untitled";
        const url2 = item.url || item.shareUrl || item.publicUrl || "";
        messages.push(createActivityMessage(`Gamma document updated: "${title}"`, url2));
      } catch {
      }
    }
    ...
    for (const item of websites) {
      try {
        const title = item.title || item.name || "Untitled";
        const url2 = item.url || item.shareUrl || item.publicUrl || "";
        messages.push(createActivityMessage(`Gamma website updated: "${title}"`, url2));
      } catch {
      }
    }
    messages.push({
...
// src/mcp/index.ts
var ListPresentationsSchema = external_exports.object({
  limit: external_exports.number().optional().default(20).describe("Number of presentations to return"),
  page: external_exports.number().optional().default(1).describe("Page number for pagination")
});
var GetPresentationSchema = external_exports.object({
  id: external_exports.string().describe("The ID of the presentation to retrieve")
});
var CreatePresentationSchema = external_exports.object({
  prompt: external_exports.string().describe("Text prompt to generate the presentation from"),
  title: external_exports.string().optional().describe("Optional title for the presentation")
});
var ListDocumentsSchema = external_exports.object({
  limit: external_exports.number().optional().default(20).describe("Number of documents to return"),
  page: external_exports.number().optional().default(1).describe("Page number for pagination")
});
var GetDocumentSchema = external_exports.object({
  id: external_exports.string().describe("The ID of the document to retrieve")
});
var ListWebsitesSchema = external_exports.object({
  limit: external_exports.number().optional().default(20).describe("Number of websites to return"),
  page: external_exports.number().optional().default(1).describe("Page number for pagination")
});
  ...
  try {
    switch (name) {
      case "gamma_list_presentations": {
        ...
        const items = (data == null ? void 0 : data.items) || (data == null ? void 0 : data.presentations) || data || [];
        if (!items.length) {
...
${list}` }] };
      ...
      case "gamma_get_presentation": {
        ...
        const p = (data == null ? void 0 : data.presentation) || data;
        return {
          content: [
            {
              type: "text",
...
URL: ${p.url || p.shareUrl || "N/A"}`
      ...
      case "gamma_list_documents": {
        ...
        const items = (data == null ? void 0 : data.items) || (data == null ? void 0 : data.documents) || data || [];
        if (!items.length) {
...
${list}` }] };
      ...
      case "gamma_get_document": {
        ...
        const d = (data == null ? void 0 : data.document) || data;
        return {
          content: [
            {
              type: "text",
...
URL: ${d.url || d.shareUrl || "N/A"}`
      ...
      case "gamma_list_websites": {
        ...
        const items = (data == null ? void 0 : data.items) || (data == null ? void 0 : data.websites) || data || [];
        if (!items.length) {
...
${list}` }] };
    ...
    const errorMessage = ((_b = (_a5 = error.response) == null ? void 0 : _a5.data) == null ? void 0 : _b.message) || error.message;
...
async function run(eventPayload) {
  switch (eventPayload.event) {
    ...
    case IntegrationEventType.CALL_TOOL: {
      ...
      const result = await callTool(name, args, config == null ? void 0 : config.api_key);
      return result;
    }
    default:
...
var GammaCLI = class extends IntegrationCLI {
  constructor() {
    super("gamma", "1.0.0");
  }
  ...
  async getSpec() {
    return {
      name: "Gamma",
      key: "gamma",
      description: "Sync your AI-generated presentations, documents, and websites from Gamma into CORE. Track content activity and manage your Gamma workspace directly from your workspace.",
      icon: "gamma",
      schedule: {
        frequency: "*/30 * * * *"
      },
          ...
          fields: [
            {
              ...
              description: "Found in Gamma \u2192 Settings \u2192 API key tab (Pro account required)."
            }
          ]
        }
      },
