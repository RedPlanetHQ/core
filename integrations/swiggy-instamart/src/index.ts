...
class SwiggyInstamartCLI extends IntegrationCLI {
  constructor() {
    super("swiggy-instamart", "1.0.0");
  }
  ...
  protected async getSpec(): Promise<Spec> {
    return {
      ...
      description:
        "Order groceries on Swiggy Instamart. Search products, manage your cart, place orders, and track deliveries.",
      icon: "swiggy-instamart",
      auth: {
        mcp: {
...
function main() {
  const cli = new SwiggyInstamartCLI();
  cli.parse();
}
