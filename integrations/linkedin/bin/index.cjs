...
// ../../node_modules/.pnpm/tsup@8.5.0_@swc+core@1.3.101_@swc+helpers@0.5.17__jiti@2.4.2_postcss@8.5.6_tsx@4.20.6_typescript@5.8.3_yaml@2.8.0/node_modules/tsup/assets/cjs_shims.js
...
async function handleSchedule(config, state) {
  try {
    const accessToken = config == null ? void 0 : config.access_token;
    if (!accessToken) {
      return [];
    }
    let settings = state || {};
...
ID: ${r.id}`;
    ...
    return {
      content: [{ type: "text", text: `Error: ${((_b = (_a5 = error.response) == null ? void 0 : _a5.data) == null ? void 0 : _b.message) || error.message}` }],
      isError: true
    };
  }
}
...
var LinkedInCLI = class extends IntegrationCLI {
  constructor() {
