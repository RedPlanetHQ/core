...
// ../../node_modules/.pnpm/tsup@8.5.0_@swc+core@1.3.101_@swc+helpers@0.5.17__jiti@2.4.2_postcss@8.5.6_tsx@4.20.6_typescript@4.9.5_yaml@2.8.0/node_modules/tsup/assets/cjs_shims.js
...
var require_populate = __commonJS({
  "../../node_modules/.pnpm/form-data@4.0.3/node_modules/form-data/lib/populate.js"(exports, module) {
    init_cjs_shims();
...
var require_form_data = __commonJS({
  "../../node_modules/.pnpm/form-data@4.0.3/node_modules/form-data/lib/form_data.js"(exports, module) {
    init_cjs_shims();
...
var require_error = __commonJS({
  "../../node_modules/.pnpm/commander@14.0.0/node_modules/commander/lib/error.js"(exports) {
    init_cjs_shims();
...
var require_argument = __commonJS({
  "../../node_modules/.pnpm/commander@14.0.0/node_modules/commander/lib/argument.js"(exports) {
    init_cjs_shims();
...
var require_help = __commonJS({
  "../../node_modules/.pnpm/commander@14.0.0/node_modules/commander/lib/help.js"(exports) {
    init_cjs_shims();
...
var require_option = __commonJS({
  "../../node_modules/.pnpm/commander@14.0.0/node_modules/commander/lib/option.js"(exports) {
    init_cjs_shims();
    var { InvalidArgumentError: InvalidArgumentError2 } = require_error();
    var Option2 = class {
      /**
...
var require_command = __commonJS({
  "../../node_modules/.pnpm/commander@14.0.0/node_modules/commander/lib/command.js"(exports) {
    init_cjs_shims();
...
var require_commander = __commonJS({
  "../../node_modules/.pnpm/commander@14.0.0/node_modules/commander/index.js"(exports) {
    init_cjs_shims();
...
// src/utils.ts
async function getCodebergData(url2, accessToken) {
...
async function integrationCreate(data) {
  ...
  const user = await getCodebergData(
...
// src/mcp/index.ts
var codebergClient;
async function initializeCodebergClient(accessToken) {
  codebergClient = axios_default.create({
...
var GetRepoSchema = external_exports.object({
  owner: external_exports.string().describe("Repository owner (username or organization)"),
  repo: external_exports.string().describe("Repository name")
});
var ListReposSchema = external_exports.object({
...
var ListIssuesSchema = external_exports.object({
  ...
  repo: external_exports.string().describe("Repository name"),
  state: external_exports.enum(["open", "closed", "all"]).optional().default("open").describe("Issue state"),
  page: external_exports.number().optional().default(1).describe("Page number"),
  limit: external_exports.number().optional().default(30).describe("Results per page")
});
var GetIssueSchema = external_exports.object({
  owner: external_exports.string().describe("Repository owner"),
  repo: external_exports.string().describe("Repository name"),
  issue_number: external_exports.number().describe("Issue number")
});
var CreateIssueSchema = external_exports.object({
  owner: external_exports.string().describe("Repository owner"),
  repo: external_exports.string().describe("Repository name"),
  title: external_exports.string().describe("Issue title"),
  body: external_exports.string().optional().describe("Issue body/description"),
  assignees: external_exports.array(external_exports.string()).optional().describe("Usernames to assign to the issue"),
  milestone: external_exports.number().optional().describe("Milestone number to associate"),
  labels: external_exports.array(external_exports.number()).optional().describe("Label IDs to associate with the issue")
});
var UpdateIssueSchema = external_exports.object({
  ...
  body: external_exports.string().optional().describe("New issue body"),
  state: external_exports.enum(["open", "closed"]).optional().describe("Issue state"),
  assignees: external_exports.array(external_exports.string()).optional().describe("Usernames to assign"),
  milestone: external_exports.number().nullable().optional().describe("Milestone number (null to remove)")
});
var ListIssueCommentsSchema = external_exports.object({
  owner: external_exports.string().describe("Repository owner"),
  repo: external_exports.string().describe("Repository name"),
  issue_number: external_exports.number().describe("Issue number")
});
var CreateIssueCommentSchema = external_exports.object({
  owner: external_exports.string().describe("Repository owner"),
  repo: external_exports.string().describe("Repository name"),
  issue_number: external_exports.number().describe("Issue number"),
  body: external_exports.string().describe("Comment body")
});
var ListPullRequestsSchema = external_exports.object({
  owner: external_exports.string().describe("Repository owner"),
  repo: external_exports.string().describe("Repository name"),
  state: external_exports.enum(["open", "closed", "all"]).optional().default("open").describe("PR state"),
  page: external_exports.number().optional().default(1).describe("Page number"),
  limit: external_exports.number().optional().default(30).describe("Results per page")
});
var GetPullRequestSchema = external_exports.object({
  owner: external_exports.string().describe("Repository owner"),
  repo: external_exports.string().describe("Repository name"),
  pull_number: external_exports.number().describe("Pull request number")
});
var CreatePullRequestSchema = external_exports.object({
  owner: external_exports.string().describe("Repository owner"),
  repo: external_exports.string().describe("Repository name"),
  title: external_exports.string().describe("Pull request title"),
  head: external_exports.string().describe("The name of the branch where your changes are implemented"),
  base: external_exports.string().describe("The name of the branch you want the changes pulled into"),
  body: external_exports.string().optional().describe("Pull request description")
});
  ...
  try {
    switch (name) {
      ...
      case "get_repo": {
        ...
        const visibility = r.private ? "\u{1F512} Private" : "\u{1F310} Public";
        const formatted = `${r.full_name} ${visibility}

Description: ${r.description || "No description"}
\u2B50 ${r.stars_count} stars | \u{1F374} ${r.forks_count} forks | \u{1F440} ${r.watchers_count} watchers
...
Clone URL: ${r.clone_url}`;
      ...
      case "list_repos": {
        ...
        const formattedRepos = response.data.map((repo) => {
          ...
          const visibility = repo.private ? "\u{1F512} Private" : "\u{1F310} Public";
...
URL: ${repo.html_url}`;
      ...
      case "list_issues": {
        ...
        const formattedIssues = response.data.map((issue) => {
          var _a6, _b2, _c2;
          const labels = ((_a6 = issue.labels) == null ? void 0 : _a6.map((l) => l.name).join(", ")) || "none";
          const assignees = ((_b2 = issue.assignees) == null ? void 0 : _b2.map((a) => a.login).join(", ")) || "unassigned";
          return `#${issue.number}: ${issue.title}
State: ${issue.state} | Author: ${(_c2 = issue.user) == null ? void 0 : _c2.login} | Comments: ${issue.comments}
Labels: ${labels}
Assignees: ${assignees}
...
URL: ${response.data.html_url}`
      ...
      case "get_issue": {
        ...
        const labels = ((_a5 = issue.labels) == null ? void 0 : _a5.map((l) => l.name).join(", ")) || "none";
        const assignees = ((_b = issue.assignees) == null ? void 0 : _b.map((a) => a.login).join(", ")) || "unassigned";
        const formatted = `#${issue.number}: ${issue.title}

State: ${issue.state} | Author: ${(_c = issue.user) == null ? void 0 : _c.login}
Created: ${issue.created_at} | Updated: ${issue.updated_at}
...
URL: ${response.data.html_url}`
      ...
      case "list_issue_comments": {
        ...
        const formattedComments = response.data.map((comment) => {
          var _a6, _b2, _c2;
          const bodyPreview = ((_a6 = comment.body) == null ? void 0 : _a6.substring(0, 150)) || "No content";
          return `ID: ${comment.id} | Author: ${(_b2 = comment.user) == null ? void 0 : _b2.login} | Created: ${comment.created_at}
${bodyPreview}${((_c2 = comment.body) == null ? void 0 : _c2.length) > 150 ? "..." : ""}
...
State: ${pr.state} | Author: ${(_a6 = pr.user) == null ? void 0 : _a6.login}
Branch: ${(_b2 = pr.head) == null ? void 0 : _b2.ref} \u2192 ${(_c2 = pr.base) == null ? void 0 : _c2.ref}
URL: ${pr.html_url}`;
        }).join("\n\n");
        return {
          content: [
...
var CodebergCLI = class extends IntegrationCLI {
  constructor() {
  ...
  async getSpec() {
    return {
      ...
      icon: "codeberg",
      // Note: You might need to add this icon to the webapp if it doesn't default to something generic or text
      schedule: {
        frequency: "*/15 * * * *"
      },
      mcp: {
