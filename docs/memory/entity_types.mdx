...
This structure enables [relationship queries](/memory/query_types) — asking "How do I know Sarah?" traverses the entity graph to find all connections: shared projects, conversations, decisions, and interactions.
