...
| --- | --- | --- |
| `memory_search` | Search the knowledge graph. | `query` (string), optional `labelIds` (array), optional `endUserIds` (array of counterparty identifiers), optional time range, optional `limit` |
