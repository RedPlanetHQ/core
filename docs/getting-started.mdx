...
<Steps>
  ...
  <Step title="Review Your Summary">
    Head to the **Document** section in your dashboard. CORE generates a summary of what it learned you. This is the foundation of your digital brain.
  </Step>
</Steps>
...
<CardGroup cols={3}>
  <Card title="Build Your Jarvis" icon="robot" href="/quickstart/chief-of-staff">
    Message CORE from WhatsApp - it takes action across your apps, browser, and machine.
  </Card>
