...
description: "Point CORE at your Claude Max or ChatGPT Codex subscription via an OpenAI-compatible proxy — works on CORE Cloud (BYOK) and self-hosted deployments."
---
