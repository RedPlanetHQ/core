...
`@butler` is for answers you want inline. Type it followed by an instruction, keep writing, and a few seconds after you stop, the butler reads the paragraph, runs the request through the CORE Agent, and posts a comment on the paragraph with what it found or did.
