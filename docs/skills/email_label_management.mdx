---
title: "How I Organise My Inbox"
description: My personal labelling policy for email — what counts as Urgent, what's a Customer signal, what's Trying to Sell, and the rest. Applied wherever email is touched — labelling tasks, triage, summaries, agent flows reading my inbox. Trigger with "how I label email", "set my inbox labelling rules", or "tell CORE how to organise my inbox".
category: Email
