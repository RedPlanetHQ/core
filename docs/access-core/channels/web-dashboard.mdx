---
title: "Web Dashboard"
description: "Chat with CORE's Meta Agent through the web interface"
---

## Overview

Access CORE's Meta Agent directly through your browser. The web dashboard provides a full-featured chat interface where you can have natural conversations, search your memory, and take actions across all your connected apps.

## Getting Started

1. Visit [app.getcore.me](https://app.getcore.me)
2. Sign in with your account
3. Start chatting with your Meta Agent
