...
#### Recurrence Rules (RRULE) Examples

Google Calendar supports RFC 5545 recurrence rules:

- **Daily for 10 times**: `RRULE:FREQ=DAILY;COUNT=10`
- **Weekly on Mon/Wed/Fri until end of year**: `RRULE:FREQ=WEEKLY;BYDAY=MO,WE,FR;UNTIL=20241231T235959Z`
