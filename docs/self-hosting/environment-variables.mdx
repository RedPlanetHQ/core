...
| `OLLAMA_MODEL`                          | No       | —                                              | Ollama chat model id (only used when `CHAT_PROVIDER=ollama`)                                     |
...
| `OLLAMA_EMBEDDING_MODEL`                | No       | —                                              | Ollama embedding model id (used when `EMBEDDINGS_PROVIDER=ollama`; falls back to `EMBEDDING_MODEL`) |
