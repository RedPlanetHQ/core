...
## Claude Max / ChatGPT Codex subscription

Already paying for Claude Max or a ChatGPT plan? You can point CORE at your subscription instead of buying API credits, using an OpenAI-compatible proxy running on infrastructure you control. Works for both self-hosted and CORE Cloud (via workspace BYOK):

→ [Use Your Claude / Codex Subscription](/gateway/subscription-proxy)
