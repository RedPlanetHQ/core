...
Already paying for Claude Max or a ChatGPT plan? You can point CORE at your subscription instead of buying API credits, using a self-hosted OpenAI-compatible proxy. See the dedicated guide:

→ [Use Your Claude / Codex Subscription](/self-hosting/subscription-proxy)
